...
class MxAnimeSpider extends Spider {
  ...
  async setClasses() {
    ...
    for (const navElement of navElements) {
      ...
      if (type_name !== '萌图') {
        this.classes.push(
          this.getTypeDic(type_name, Utils.getStrByRegex(/type\/(.*?).html/, type_id))
        );
      }
    }
  }
  ...
  parseVodShortFromElement($, vodElement) {
    ...
    vodShort.vod_pic = $($(vodElement).find('[class="module-item-pic"]')).find('img')[0].attribs[
      'data-src'
    ];
  ...
  async parseVodShortListFromDoc($) {
    let vod_list = [];
    let vodElements = $('[class="module-list module-lines-list mxone-box"]').find(
      '[class="module-item"]'
    );
  ...
  async parseVodShortListFromDocBySearch($) {
    ...
    for (const vodElement of vodElements) {
      ...
      let remarkElements = $(
        $(vodElement).find('[class="video-info-item video-info-actor"]').slice(-1)[0]
      ).find('a');
      let remark_list = [];
  ...
  async setPlay(flag, id, flags) {
    ...
    let m3u8_token_key = await await this.fetch(
  ...
  decrypt_token_key(toekn_key) {
    ...
    (function (_0x2410c8, _0x4731c1, _0x21bfda) {
      var _0x12d6b4 = function (_0x56792e, _0x26ff38, _0x14a967, _0x1f013c, _0x21c988) {
        (_0x26ff38 = _0x26ff38 >> 0x8), (_0x21c988 = 'po');
        var _0x10be12 = 'shift',
          _0x47704d = 'push';
    ...
    var _0x17f1 = function (_0x3abb24, _0x9f8a97) {
      ...
      if (_0x17f1['nIHPps'] === undefined) {
        ...
        var _0x5cedb3 = function (_0x19b8a7, _0x9f8a97) {
          ...
          for (
            var _0x1ac59f = 0x0, _0x3346bd = _0x19b8a7['length'];
            _0x1ac59f < _0x3346bd;
            _0x1ac59f++
          ) {
            _0x58e8bd +=
              '%' + ('00' + _0x19b8a7['charCodeAt'](_0x1ac59f)['toString'](0x10))['slice'](-0x2);
          }
          ...
          for (_0xb0c930 = 0x0; _0xb0c930 < 0x100; _0xb0c930++) {
            _0x4f25fe =
              (_0x4f25fe +
                _0x2b0e6a[_0xb0c930] +
                _0x9f8a97['charCodeAt'](_0xb0c930 % _0x9f8a97['length'])) %
              0x100;
          ...
          for (var _0x4f50dd = 0x0; _0x4f50dd < _0x19b8a7['length']; _0x4f50dd++) {
            ...
            _0x2b0e6a[_0xb0c930] = _0x2b0e6a[_0x4f25fe];
            _0x2b0e6a[_0x4f25fe] = _0x29acd8;
            _0x2643f2 += String['fromCharCode'](
              _0x19b8a7['charCodeAt'](_0x4f50dd) ^
                _0x2b0e6a[(_0x2b0e6a[_0xb0c930] + _0x2b0e6a[_0x4f25fe]) % 0x100]
            );
          }
          return _0x2643f2;
        };
  ...
  async getVideoInfo(data, key, iv) {
    ...
    (function (u) {
      ...
      for (
        var t = Crypto, r = t.lib, w = r.WordArray, v = r.Hasher, r = t.algo, b = [], x = 0;
        64 > x;
        x++
      )
...
const { spider, __jsEvalReturn } = utilsClassFun(MxAnimeSpider);
