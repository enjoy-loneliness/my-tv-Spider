...
function _0xf746(_0xbb40c4, _0x1cb776) {
  ...
  return (
    (_0xf746 = function (_0xf74696, _0x4d32af) {
...
(function (_0x27923d, _0x43d7fc) {
  const _0x439396 = _0xf746,
    _0x30f164 = _0x27923d();
  while (!![]) {
    try {
      const _0xa560eb =
        -parseInt(_0x439396(0x1b4)) / 0x1 +
        parseInt(_0x439396(0x1ad)) / 0x2 +
        (-parseInt(_0x439396(0x1b1)) / 0x3) * (-parseInt(_0x439396(0x1b5)) / 0x4) +
        -parseInt(_0x439396(0x1b0)) / 0x5 +
        parseInt(_0x439396(0x1aa)) / 0x6 +
        parseInt(_0x439396(0x1ac)) / 0x7 +
        parseInt(_0x439396(0x1a8)) / 0x8;
      if (_0xa560eb === _0x43d7fc) break;
      else _0x30f164['push'](_0x30f164['shift']());
    } catch (_0x3ae316) {
...
class IKanBotSpider extends Spider {
  ...
  async parseVodDetailFromDoc($) {
    ...
    vodDetail.vod_pic =
      this.jsBase + Utils.base64Encode($('div.item-root > img')[0].attribs['data-src']);
  ...
  async setClasses() {
    ...
    if (!_.isEmpty(html)) {
      let $ = load(html);
      let classElements = $(
        $($('[class="row visible-xs-block visible-sm-block"]')).find('li')
      ).find('a');
      for (const classElement of classElements) {
        this.classes.push({
          'type_name': $(classElement).text(),
          'type_id': classElement.attribs['href'],
        });
      }
    }
  }
    ...
    for (const class_dic of this.classes.slice(1, 9)) {
      ...
      if (type_id.indexOf('category') === -1 || type_id.indexOf(',') > -1) {
        ...
        if (!_.isEmpty(html)) {
          ...
          let extend_dic = {
            'key': type_id,
            'name': $(containerElement.find('h5')).text(),
            'value': value_list,
          };
...
const { spider, __jsEvalReturn } = utilsClassFun(IKanBotSpider);
