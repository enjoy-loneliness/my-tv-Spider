...
class DJ0898Spider extends Spider {
  ...
  async setClasses() {
    this.classes = [
      { type_id: 1, type_name: '🎧串烧舞曲' },
      { type_id: 2, type_name: '🎧外文舞曲' },
      {
        type_id: 3,
        type_name: '🎧早场暖场',
      },
      { type_id: 4, type_name: '🎧中文舞曲' },
      { type_id: 5, type_name: '🎧其他舞曲' },
      {
        type_id: 6,
        type_name: '🎧国外电音',
      },
      { type_id: 8, type_name: '🎧慢歌连版' },
      { type_id: 9, type_name: '🎧酒吧潮歌' },
      {
        type_id: 10,
        type_name: '🎧中文串烧',
      },
      { type_id: 11, type_name: '🎧外文串烧' },
      { type_id: 12, type_name: '🎧中外串烧' },
      {
        type_id: 13,
        type_name: '🎧车载串烧',
      },
      { type_id: 14, type_name: '🎧越鼓串烧' },
      { type_id: 40, type_name: '🎧3D/环绕' },
      {
        type_id: 45,
        type_name: '🎧口水旋律',
      },
      { type_id: 46, type_name: '🎧精品收藏' },
      { type_id: 47, type_name: '🎧开场舞曲' },
      {
        type_id: 48,
        type_name: '🎧印度舞曲',
      },
      { type_id: 49, type_name: '🎧编排套曲' },
      { type_id: 20, type_name: '🎧DuTch' },
      {
        type_id: 21,
        type_name: '🎧Mash up',
      },
      { type_id: 22, type_name: '🎧ClubHouse' },
      { type_id: 23, type_name: '🎧ElectroHouse' },
      {
        type_id: 24,
        type_name: '🎧越南鼓Dj',
      },
      { type_id: 30, type_name: '🎧Funky' },
      { type_id: 31, type_name: '🎧Reggae' },
      {
        type_id: 32,
        type_name: '🎧Rnb',
      },
      { type_id: 33, type_name: '🎧Hip Hop' },
      { type_id: 34, type_name: '🎧Dubstep' },
      {
        type_id: 8017,
        type_name: '🎧Hardstyle',
      },
...
const { spider, __jsEvalReturn } = utilsClassFun(DJ0898Spider);
